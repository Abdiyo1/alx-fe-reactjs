function UserProfile() {
    return (
      <div className="bg-gray-100    my-20 rounded-lg shadow-lg sm:max-w-xs md:max-w-sm sm:p-4 md:p-8">
        <img className="rounded-full  sm:w-24 sm:h-24 md:w-36 md:h-36 " src="https://th.bing.com/th/id/OIP.8cwjJRW8Rxvk8JwuidaHMgHaJQ?w=156&h=195&c=7&r=0&o=5&pid=1.7" alt="User" />
